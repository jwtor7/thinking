...
- **v1.2.1** (2026-02-08) — Fixed EventReceiver timer cleanup leak, corrected session-scoped task filtering, moved timeline insertion after handler dispatch for accurate session attribution, and added root teams/tasks removal broadcasts.
