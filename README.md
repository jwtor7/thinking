...
[![Version](https://img.shields.io/badge/version-0.16.7-purple)](./CHANGELOG.md)
...
- **v0.16.7** (2026-01-11) — Multi-session distinction: folder badges + unique session ID colors for entries in same folder
